...
def summary():
    ...
    #print values
    text = f"There are {total_chats} chats to date with user asking {user_utterances} times and system reponding {system_utterances} times. Total duration is {time} seconds."
    print("\n"+text+"\n")
    return text
